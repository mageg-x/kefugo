...
const (
	...
	// 32000-32099: 通知/绑定
	ErrCodeNotificationChannelUnsupported   ErrorCode = 32000
	ErrCodeNotificationChannelNotConfigured ErrorCode = 32001
	ErrCodeNotificationBindStateRequired    ErrorCode = 32002
	ErrCodeNotificationBindExpired          ErrorCode = 32003
	ErrCodeNotificationBindChannelMismatch  ErrorCode = 32004
	ErrCodeNotificationBindInfoFailed       ErrorCode = 32005
	ErrCodeNotificationUnbindFailed         ErrorCode = 32006
	ErrCodeNotificationBindFailed           ErrorCode = 32007

	// 32100-32199: 企业微信
	ErrCodeWecomConfigInvalid         ErrorCode = 32100
	ErrCodeWecomConfigSerializeFailed ErrorCode = 32101
	ErrCodeWecomConfigSaveFailed      ErrorCode = 32102
	ErrCodeWecomConfigUpdateFailed    ErrorCode = 32103
	ErrCodeWecomCredentialsRequired   ErrorCode = 32104
	ErrCodeWecomNotConfigured         ErrorCode = 32105
	ErrCodeWecomBindStateRequired     ErrorCode = 32106
	ErrCodeWecomBindExpired           ErrorCode = 32107
	ErrCodeWecomBindInfoFailed        ErrorCode = 32108
	ErrCodeWecomUnbindFailed          ErrorCode = 32109
	ErrCodeWecomCallbackInvalid       ErrorCode = 32110
	ErrCodeWecomCallbackFailed        ErrorCode = 32111
	ErrCodeWecomBindFailed            ErrorCode = 32112
...
var ErrorMessages = map[ErrorCode]string{
	...
	ErrCodeNotificationChannelUnsupported:   "unsupported notification bind channel",
	ErrCodeNotificationChannelNotConfigured: "notification channel not configured or disabled",
	ErrCodeNotificationBindStateRequired:    "notification bind state required",
	ErrCodeNotificationBindExpired:          "notification bind qr code expired",
	ErrCodeNotificationBindChannelMismatch:  "notification bind channel mismatch",
	ErrCodeNotificationBindInfoFailed:       "load notification bind info failed",
	ErrCodeNotificationUnbindFailed:         "unbind notification channel failed",
	ErrCodeNotificationBindFailed:           "bind notification channel failed",
	ErrCodeWecomConfigInvalid:               "invalid wecom config parameters",
	ErrCodeWecomConfigSerializeFailed:       "serialize wecom config failed",
	ErrCodeWecomConfigSaveFailed:            "save wecom config failed",
	ErrCodeWecomConfigUpdateFailed:          "update wecom config failed",
	ErrCodeWecomCredentialsRequired:         "wecom corp id and secret required",
	ErrCodeWecomNotConfigured:               "wecom is not configured",
	ErrCodeWecomBindStateRequired:           "wecom bind state required",
	ErrCodeWecomBindExpired:                 "wecom bind qr code expired",
	ErrCodeWecomBindInfoFailed:              "load wecom bind info failed",
	ErrCodeWecomUnbindFailed:                "unbind wecom failed",
	ErrCodeWecomCallbackInvalid:             "invalid wecom callback parameters",
	ErrCodeWecomCallbackFailed:              "wecom callback failed",
	ErrCodeWecomBindFailed:                  "bind wecom failed",
}
